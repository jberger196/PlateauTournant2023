...
{
    char reponse;
    AlimentationBatterie *lAlimentationBatterie = new AlimentationBatterie(23,0x44);
    ...
    cout << "- alimenter la batterie (b)" << endl;
    cout << "- couper l'alimentation batterie (f)" << endl;
    ...
    {
        lOperation->alimenterBatterie();
    }
    else if (reponse == 'f')
    {
        lAlimentationBatterie->couper();
    }
    } while ( reponse != 'o');
